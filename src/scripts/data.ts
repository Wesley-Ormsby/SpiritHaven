...
export const POWERS: Record<string, PowerCard> = {
  ...
  'call to bloodshed': {
    ...
    range: 1,
    target: 'dahan',
    effect: '1 Damage per Dahan. -or- Gather up to 3 Dahan.',
    threshhold: null,
    artist: 'Jorge Ramos',
    status: 'active',
    from: null,
  ...
  'call to isolation': {
    ...
    range: 1,
    target: 'dahan',
    effect: 'Push 1 Explorer/Town per Dahan. -or- Push 1 Dahan.',
    threshhold: null,
  ...
  'land of haunts and embers': {
    ...
    target: 'any land',
    effect:
      '2 Fear. Push up to 2 Explorers/Towns. If Blight is present, 2 Fear and Push up to 2 Explorers/Towns. Add 1 Blight.',
    threshhold: null,
    artist: 'Jorge Ramos',
    status: 'active',
    from: null,
  ...
  'pull beneath the hungry earth': {
    ...
    target: 'any land',
    effect:
      'If your Presence is present, 1 Fear and 1 Damage. If target land is a Sands or Wetland, 1 Damage.',
    threshhold: null,
    artist: 'Nolan Nasser',
    status: 'active',
    from: null,
  ...
  'gift of living energy': {
    ...
    target: 'any spirit',
    effect:
      'Target Spirit gains 1 Energy. If you have at least 2 Sacred Sites, target Spirit gains 1 Energy. If you target another Spirit, they gain 1 Energy.',
    threshhold: null,
    artist: 'Nolan Nasser',
    status: 'active',
    from: null,
  ...
  "quicken the earth's struggles": {
    image:
      'https://spiritislandwiki.com/images/4/49/Quicken_the_Earth%27s_Struggles_%28hosi%29.png',
    set: ['Spirit Island', 'Horizons of Spirit Island'],
    cardType: 'minor',
    cost: 1,
    elements: ['m', 'f', 'e', 'n'],
    ...
    range: 0,
    target: 'any land',
    effect: '1 Damage to each Town/City. -or- Defend 10.',
    threshhold: null,
    artist: 'Lucas Durham',
    status: 'active',
    from: 'sacred site',
  ...
  'enticing splendor': {
    ...
    range: 0,
    target: 'no blight',
    effect: 'Gather 1 Explorer/Town. -or- Gather up to 2 Dahan.',
    threshhold: null,
    artist: 'Joshua Wright',
    status: 'active',
    from: null,
  ...
  'purifying flame': {
    ...
    target: 'any land',
    effect:
      '1 Damage per Blight. If target land is a Mountain or Sands, you may instead Remove 1 Blight.',
    threshhold: null,
    artist: 'Jorge Ramos',
    status: 'active',
    from: 'sacred site',
  ...
  'animated wrackroot': {
    ...
    range: 0,
    target: 'any land',
    effect: '1 Fear. Destroy 1 Explorer. -or- Add 1 Wilds.',
    threshhold: null,
    artist: 'Joshua Wright',
    status: 'active',
    from: null,
  ...
  'delusions of danger': {
    ...
    range: 1,
    target: 'any land',
    effect: 'Push 1 Explorer. -or- 2 Fear.',
    threshhold: null,
    artist: 'Moro Rogers',
    status: 'active',
    from: null,
  ...
  'absorb corruption': {
    ...
    range: 0,
    target: 'any land',
    effect: 'Gather 1 Blight. -or- Pay 1 Energy to Remove 1 Blight.',
    threshhold: {
      elements: {
        p: 2,
      },
  ...
  'blazing renewal': {
    ...
    target: 'any spirit',
    effect:
      'In a single land within 2 Range of your Presence: target Spirit Adds 2 of their Destroyed Presence. If any Presence was Added, 2 Damage to each Town/City.',
    threshhold: {
      elements: {
        f: 3,
        e: 3,
  ...
  "veil the night's hunt": {
    ...
    target: 'dahan',
    effect:
      'For each Dahan present, choose a different Invader. 1 Damage to each of those Invaders. -or- Push up to 3 Dahan.',
    threshhold: null,
    artist: 'Loic Belliau',
    status: 'active',
    from: null,
  ...
  'dissolve the bonds of kinship': {
    ...
    target: 'any land',
    effect:
      'Replace 1 City with 2 Explorers. Replace 1 Town with 1 Explorer. Replace 1 Dahan with 1 Explorer. Push all Explorers from target land to as many different lands as possible.',
    threshhold: {
      elements: {
        f: 2,
        w: 2,
  ...
  'vigor of the breaking dawn': {
    ...
    threshhold: {
      ...
      ability:
        'You may Push up to 2 Dahan. In lands you Pushed Dahan to, 2 Damage per Dahan present.',
    },
    artist: 'Loic Belliau',
    status: 'active',
    from: null,
  ...
  'guardian serpents': {
    ...
    target: 'any spirit',
    effect:
      "Add 1 Beasts in one of target Spirit's lands. If target Spirit has a Sacred Site in that land: Defend 4 there.",
    threshhold: null,
    artist: 'Moro Rogers',
    status: 'active',
    from: null,
  ...
  'indomitable claim': {
    ...
    threshhold: {
      ...
      ability:
        '3 Fear if Invaders are present. Skip all Invader Actions. (Do not Ravage, Build, or Explore in target land.)',
    },
    artist: 'Jorge Ramos',
    status: 'active',
    from: null,
  ...
  tsunami: {
    ...
    threshhold: {
      ...
      ability:
        'In each other Coastal land on the same board: 1 Fear, 4 Damage, and Destroy 1 Dahan.',
    },
    artist: 'Jason Behnke',
    status: 'active',
    from: 'sacred site',
  ...
  'cast down into the briny deep': {
    ...
    threshhold: {
      ...
      ability:
        'Destroy the board containing target land and everything on that board. All Destroyed Blight is Removed from the game instead of being returned to the Blight Card.',
    },
    artist: 'Jason Behnke',
    status: 'active',
    from: 'sacred site',
  ...
  'insatiable hunger of the swarm': {
    ...
    target: 'any land',
    effect:
      'Add 1 Blight. Add 2 Beasts. Gather up to 2 Beasts. Each Beasts deals 1 Fear, 2 Damage to Invaders and 2 Damage to Dahan. Destroy 1 Beasts.',
    threshhold: {
      elements: {
        a: 2,
        n: 4,
  ...
  'infested aquifers': {
    ...
    target: 'any land',
    effect:
      'If target land has any Disease, 1 Damage to each Invader. -or- If target land is a Mountain or Wetland, 1 Fear and add 1 Disease.',
    threshhold: null,
    artist: 'Nolan Nasser',
    status: 'active',
    from: null,
  ...
  'uncanny melting': {
    ...
    target: 'any land',
    effect:
      'If Invaders are present, 1 Fear. If target land is a Sands or Wetland, Remove 1 Blight.',
    threshhold: null,
    artist: 'Joshua Wright',
    status: 'active',
    from: 'sacred site',
  ...
  'prowling panthers': {
    ...
    range: 1,
    target: 'mountain or jungle',
    effect: '1 Fear. Add 1 Beasts. -or- If target land has Beasts, Destroy 1 Explorer/Town.',
    threshhold: null,
    artist: 'Moro Rogers',
    status: 'active',
    from: null,
  ...
  powerstorm: {
    ...
    target: 'any spirit',
    effect:
      'Target Spirit gains 3 Energy. Once this turn, target Spirit may Repeat a Power Card by paying its cost again.',
    threshhold: {
      elements: {
        s: 2,
        f: 2,
  ...
  'the trees and stones speak of war': {
    image:
      'https://spiritislandwiki.com/images/8/81/The_Trees_and_Stones_Speak_of_War_%28hosi%29.png',
    set: ['Spirit Island', 'Horizons of Spirit Island'],
    cardType: 'major',
    cost: 2,
    elements: ['s', 'e', 'p'],
  ...
  'unlock the gates of deepest power': {
    image:
      'https://spiritislandwiki.com/images/0/0d/Unlock_the_Gates_of_Deepest_Power_%28bc%29.png',
    set: ['Branch and Claw'],
    cardType: 'major',
    cost: 4,
    elements: ['s', 'm', 'f', 'a', 'w', 'e', 'p', 'n'],
    speed: 'fast',
    range: null,
    target: 'any spirit',
    effect:
    ...
    threshhold: {
      ...
      ability:
        'Target Spirit may now play the Major Power they keep by paying half its cost (round up) OR by Forgetting it at the end of turn. It gains all elemental thresholds.',
    },
    artist: 'Joshua Wright',
    status: 'active',
    from: null,
  ...
  'inflame the fires of life': {
    ...
    range: 1,
    target: 'any land',
    effect: 'Add 1 Disease. -or- 1 Fear. Add 1 Strife.',
    threshhold: {
      elements: {
        n: 3,
      },
  ...
  'teeth gleam from darkness': {
    ...
    range: 1,
    target: 'no blight',
    effect: '1 Fear. Add 1 Beasts. -or- If target land has both Beasts and Invaders: 3 Fear.',
    threshhold: null,
    artist: 'Moro Rogers',
    status: 'active',
    from: 'jungle',
  ...
  'strangling firevine': {
    ...
    target: 'any land',
    effect:
      'Destroy all Explorers. Add 1 Wilds. Add 1 Wilds in the originating Sands. 1 Damage per Wilds in/adjacent to target land.',
    threshhold: {
      elements: {
        f: 2,
        p: 3,
  ...
  'vengeance of the dead': {
    ...
    target: 'any land',
    effect:
      '3 Fear. After Towns/Cities/Dahan are Destroyed in target land, 1 Damage per Town/City/Dahan Destroyed. (This cannot trigger itself.)',
    threshhold: {
      elements: {
        n: 3,
      },
  ...
  'instruments of their own ruin': {
    ...
    threshhold: {
      ...
      ability:
        'Instead, if Invaders Ravage in target land, they Damage Invaders in adjacent lands instead of Dahan and the land. Dahan in target land do not fight back.',
    },
    artist: 'Lucas Durham',
    status: 'active',
    from: 'sacred site',
  ...
  'death falls gently from open blossoms': {
    image:
      'https://spiritislandwiki.com/images/e/e3/Death_Falls_Gently_from_Open_Blossoms_%28bc%29.png',
    set: ['Branch and Claw'],
    cardType: 'major',
    cost: 4,
    elements: ['m', 'a', 'p'],
  ...
  'sacrosanct wilderness': {
    ...
    range: 1,
    target: 'no blight',
    effect: 'Push 2 Dahan. 2 Damage per Wilds in target land. -or- Add 1 Wilds.',
    threshhold: null,
    artist: 'Joshua Wright',
    status: 'active',
    from: null,
  ...
  'sweep into the sea': {
    ...
    target: 'any land',
    effect:
      'Push all Explorers and Towns one land towards the nearest Ocean. -or- If target land is Coastal, Destroy all Explorers and Towns.',
    threshhold: {
      elements: {
        s: 3,
        w: 2,
  ...
  'swarming wasps': {
    ...
    range: 1,
    target: 'no blight',
    effect: 'Add 1 Beasts. -or- If target land has Beasts, Push up to 2 Explorers.',
    threshhold: null,
    artist: 'Joshua Wright',
    status: 'active',
    from: null,
  ...
  'sea monsters': {
    ...
    set: ['Branch and Claw', 'Jagged Earth'],
    cardType: 'major',
    cost: 5,
    elements: ['w', 'n'],
    speed: 'slow',
  ...
  'asphyxiating smoke': {
    ...
    set: ['Promo Pack 1', 'Feather and Flame'],
    cardType: 'unique',
    cost: 2,
    elements: ['f', 'a', 'p'],
    speed: 'slow',
  ...
  "unleash a torrent of the self's own essence": {
    image:
      'https://spiritislandwiki.com/images/3/37/Unleash_a_Torrent_of_the_Self%27s_Own_Essence_%28je%29.png',
    set: ['Jagged Earth'],
    cardType: 'major',
    cost: 2,
    elements: ['s', 'm', 'f', 'w'],
    ...
    target: 'yourself',
    effect:
      'Gain 4 Energy. You may forget a Power card to gain 4 more Energy. -or- Pay X Energy (min. 1) to deal X Damage in a land at 0 Range.',
    threshhold: {
      elements: {
        s: 2,
        f: 3,
  ...
  'voracious growth': {
    ...
    range: 1,
    target: 'jungle or wetland',
    effect: '2 Damage. -or- Remove 1 Blight.',
    threshhold: null,
    artist: 'Cari Corene',
    status: 'active',
    from: 'sacred site',
  ...
  'the land thrashes in furious pain': {
    image:
      'https://spiritislandwiki.com/images/e/eb/The_Land_Thrashes_in_Furious_Pain_%28hosi%29.png',
    set: ['Spirit Island', 'Horizons of Spirit Island'],
    cardType: 'major',
    cost: 4,
    elements: ['m', 'f', 'e'],
  ...
  'dry wood explodes in smoldering splinters': {
    image:
      'https://spiritislandwiki.com/images/e/ee/Dry_Wood_Explodes_in_Smoldering_Splinters_%28je%29.png',
    set: ['Jagged Earth'],
    cardType: 'minor',
    cost: 1,
    elements: ['f', 'a', 'p'],
  ...
  'manifestation of power and glory': {
    image:
      'https://spiritislandwiki.com/images/4/43/Manifestation_of_Power_and_Glory_%28base%29.png',
    set: ['Spirit Island'],
    cardType: 'unique',
    cost: 3,
    elements: ['s', 'f', 'a'],
  ...
  'skies herald the season of return': {
    image:
      'https://spiritislandwiki.com/images/b/b2/Skies_Herald_the_Season_of_Return_%28je%29.png',
    set: ['Jagged Earth'],
    cardType: 'minor',
    cost: 1,
    elements: ['s', 'm', 'p', 'n'],
  ...
  "sunset's fire flows across the land": {
    image:
      'https://spiritislandwiki.com/images/4/4a/Sunset%27s_Fire_Flows_Across_the_Land_%28je%29.png',
    set: ['Jagged Earth'],
    cardType: 'minor',
    cost: 1,
    elements: ['s', 'm', 'f', 'w'],
  ...
  'gift of the primordial deeps': {
    ...
    target: 'another spirit',
    effect:
      'Target Spirit gains a Minor Power. Target Spirit chooses to either: Play it immediately by paying its cost. -or- Gain 1Moon and 1Earth.',
    threshhold: null,
    artist: 'Jorge Ramos',
    status: 'active',
    from: null,
  ...
  'absorb essence': {
    ...
    target: 'another spirit',
    effect:
      'Gain 3 Energy. Move 1 of target Spirit\'s Presence from the board to your "Deep Slumber" track. Absorbed Presence cannot be returned to play. Target Spirit gains 1 Any (Element) and 1 Energy.',
    threshhold: null,
    artist: 'Jorge Ramos',
    status: 'active',
    from: null,
  ...
  'strong and constant currents': {
    ...
    target: 'coastal',
    effect:
      'Push 1 Explorer/Town to an adjacent Coastal land. -or- Move up to 2 Dahan between target land and one other Coastal land.',
    threshhold: {
      elements: {
        w: 2,
      },
  ...
  'sleep and never waken': {
    ...
    target: 'any land',
    effect:
      'Invaders skip all Actions in target land. 1 Fear per 2 Explorers this Power Removes. Remove up to 2 Explorers.',
    threshhold: {
      elements: {
        m: 3,
        a: 2,
  ...
  'sear anger into the wild lands': {
    ...
    range: 1,
    target: 'any land',
    effect: 'Add 1 Badlands. -or- If Wilds and Invaders are present, 1 Fear and 1 Damage.',
    threshhold: null,
    artist: 'Kat Guevara',
    status: 'active',
    from: null,
  ...
  "focus the land's anguish": {
    ...
    target: 'any land',
    effect:
      'If this Power Destroys any Towns/Cities, 5 Fear. Gather up to 5 Blight. 1 Damage per Blight.',
    threshhold: {
      elements: {
        s: 3,
      },
  ...
  'exaltation of molten stone': {
    ...
    target: 'another spirit',
    effect:
      'Split 1 Energy per Fire you have between yourself and target Spirit, as evenly as possible. (Gained from the supply.) Target Spirit gains +1 Range with their Powers that originate from a Mountain.',
    threshhold: null,
    artist: 'Moro Rogers',
    status: 'active',
    from: null,
  ...
  'gift of flowing power': {
    ...
    target: 'another spirit',
    effect:
      'Target Spirit gains 1 Energy. Target Spirit chooses to either: Play another Power Card by paying its cost. -or- Gain 1Fire and 1Water.',
    threshhold: null,
    artist: 'Jorge Ramos',
    status: 'active',
    from: null,
  ...
  'storm-swath': {
    ...
    threshhold: {
      ...
      ability:
        '+1 Fear. This Power has +1 Range. In a land adjacent to both origin and target, 1 Damage to each Invader. In lands where you did Damage, Destroy 1 Town.',
    },
    artist: 'Jorge Ramos',
    status: 'active',
    from: 'sacred site',
  ...
  'pursue with scratches, pecks, and stings': {
    image:
      'https://spiritislandwiki.com/images/7/7e/Pursue_with_Scratches%2C_Pecks%2C_and_Stings_%28je%29.png',
    set: ['Jagged Earth'],
    cardType: 'unique',
    cost: 0,
    elements: ['s', 'f', 'a', 'n'],
  ...
  'a dreadful tide of scurrying flesh': {
    image:
      'https://spiritislandwiki.com/images/c/c1/A_Dreadful_Tide_of_Scurrying_Flesh_%28je%29.png',
    set: ['Jagged Earth'],
    cardType: 'unique',
    cost: 0,
    elements: ['m', 'a', 'w', 'n'],
  ...
  'bats scout for raids by darkness': {
    ...
    range: 2,
    target: 'any land',
    effect: 'For each Dahan, 1 Damage to Towns/Cities. -or- 1 Fear. Gather up to 2 Dahan.',
    threshhold: null,
    artist: 'Shawn Daley',
    status: 'active',
    from: null,
  ...
  'dream of the untouched land': {
    ...
    threshhold: {
      ...
      ability:
        '(Max. 1x/game) Add a random new Island Board next to target board. Ignore its Setup icons; add 2 Beasts, 2 Wilds, 2 Badlands and up to 2 Presence (from any Spirits) anywhere on it. From now on, Build cards and "Each board / Each land" Adversary Actions skip 1 Board.',
    },
    artist: 'Joshua Wright',
    status: 'active',
    from: 'sacred site',
  ...
  'thickets erupt with every touch of breeze': {
    image:
      'https://spiritislandwiki.com/images/d/da/Thickets_Erupt_with_Every_Touch_of_Breeze_%28je%29.png',
    set: ['Jagged Earth'],
    cardType: 'major',
    cost: 3,
    elements: ['a', 'p'],
    ...
    range: 2,
    target: 'inland',
    effect: '2 Damage. Then either: Add 3 Wilds. -or- Remove 1 Blight.',
    threshhold: {
      elements: {
        p: 3,
      },
  ...
  'infinite vitality': {
    ...
    target: 'any land',
    effect:
      'Dahan have +4 Health (while in target land). Blight cannot be Added. (When it would be added to target land, instead leave it on the Blight space.)',
    threshhold: {
      elements: {
        e: 4,
      },
      ability:
        'Dahan cannot be Damaged or Destroyed (in target land). Remove 1 Blight from target or adjacent land.',
    },
    artist: 'Joshua Wright',
    status: 'active',
    from: 'sacred site',
  ...
  'gather the scattered light of stars': {
    image:
      'https://spiritislandwiki.com/images/f/f0/Gather_the_Scattered_Light_of_Stars_%28je%29.png',
    set: ['Jagged Earth'],
    cardType: 'unique',
    cost: 0,
    elements: ['m'],
  ...
  'voice of command': {
    ...
    target: 'dahan',
    effect:
      '1 Damage per Dahan/Explorer, to Towns/Cities only. Defend 2. During Ravage Actions, Explorers fight alongside Dahan. (Deal/take Damage at the same time, and to/from the same sources.)',
    threshhold: {
      elements: {
        s: 3,
        a: 2,
  ...
  'call to tend': {
    ...
    range: 1,
    target: 'dahan',
    effect: 'Remove 1 Blight. -or- Push up to 3 Dahan.',
    threshhold: null,
    artist: 'Loic Belliau',
    status: 'active',
    from: null,
  ...
  'trees radiate celestial brilliance': {
    image:
      'https://spiritislandwiki.com/images/6/65/Trees_Radiate_Celestial_Brilliance_%28je%29.png',
    set: ['Jagged Earth'],
    cardType: 'major',
    cost: 3,
    elements: ['s', 'm', 'p'],
  ...
  'the past returns again': {
    ...
    target: null,
    effect:
      "Cost to Use: N Time, and Spirits jointly pay N Energy (where N = # of players). Swap the top card of the Invader Deck with a card in the Invader discard that is within 1 Invader Stage of it. (The discarded card stays face-down. The card going into the deck turns face-down. You can't swap cards that don't exist.)",
    threshhold: null,
    artist: 'Lucas Durham',
    status: 'active',
    from: null,
  ...
  'favor of the sun and star-lit dark': {
    image:
      'https://spiritislandwiki.com/images/0/00/Favor_of_the_Sun_and_Star-lit_Dark_%28je%29.png',
    set: ['Jagged Earth'],
    cardType: 'minor',
    cost: 1,
    elements: ['s', 'm', 'p'],
  ...
  'the wounded wild turns on its assailants': {
    image:
      'https://spiritislandwiki.com/images/2/26/The_Wounded_Wild_Turns_on_its_Assailants_%28je%29.png',
    set: ['Jagged Earth'],
    cardType: 'major',
    cost: 4,
    elements: ['f', 'p', 'n'],
  ...
  'treacherous waterways': {
    ...
    range: 1,
    target: 'mountain or wetland',
    effect: 'Add 1 Wilds. -or- Push 1 Explorer.',
    threshhold: null,
    artist: 'Kat Guevara',
    status: 'active',
    from: null,
  ...
  'voice of thunder': {
    ...
    range: 1,
    target: 'any land',
    effect: 'Push up to 4 Dahan. -or- If Invaders are present, 2 Fear.',
    threshhold: null,
    artist: 'Loic Belliau',
    status: 'active',
    from: null,
  ...
  'forests of living obsidian': {
    ...
    target: 'any land',
    effect:
      'Add 1 Badlands. Push all Dahan. 1 Damage to each Invader. If the origin land is your Sacred Site, +1 Damage to each Invader.',
    threshhold: {
      elements: {
        s: 2,
        f: 3,
  ...
  'utter a curse of dread and bone': {
    ...
    target: 'any land',
    effect:
      'For each Blight in/adjacent to target land, add 1 Badlands, 1 Disease, or 1 Strife. (Max. +3 of each.) Then: 2 Fear. 1 Damage.',
    threshhold: {
      elements: {
        m: 3,
        n: 2,
      ...
      ability:
        'For each type of token you added, add 1 more within 1 Range. 1 Damage in an adjacent land.',
    },
    artist: 'Joshua Wright',
    status: 'active',
    from: 'sacred site',
  ...
  'boon of reimagining': {
    ...
    target: 'any spirit',
    effect:
      'Target Spirit may Forget a Power Card from hand or discard to draw 6 Minor Power Cards and gain 2 of them. If you target another Spirit, they gain 1 Energy.',
    threshhold: null,
    artist: 'Emily Hancock',
    status: 'active',
    from: null,
  ...
  'twisted flowers murmur ultimatums': {
    image:
      'https://spiritislandwiki.com/images/e/e2/Twisted_Flowers_Murmur_Ultimatums_%28bc%29.png',
    set: ['Branch and Claw'],
    cardType: 'major',
    cost: 5,
    elements: ['s', 'm', 'a', 'e', 'p'],
  ...
  'flow like water, reach like air': {
    image:
      'https://spiritislandwiki.com/images/b/bd/Flow_like_Water%2C_Reach_like_Air_%28bc%29.png',
    set: ['Branch and Claw'],
    cardType: 'major',
    cost: 2,
    elements: ['a', 'w'],
    ...
    target: 'any spirit',
    effect:
      'Target Spirit gets +2 Range with all Powers. Target Spirit may Push 1 of their Presence to an adjacent land, bringing up to 2 Explorers, 2 Towns and 2 Dahan along with it.',
    threshhold: {
      elements: {
        a: 2,
        w: 2,
  ...
  'weave together the fabric of place': {
    image:
      'https://spiritislandwiki.com/images/c/c2/Weave_Together_the_Fabric_of_Place_%28je%29.png',
    set: ['Jagged Earth'],
    cardType: 'major',
    cost: 4,
    elements: ['s', 'm', 'a', 'w', 'e'],
  ...
  'ferocious rampage': {
    ...
    target: 'any land',
    effect:
      '1 Fear. 3 Damage to Explorer/Town only. (+1 Damage to Explorers/Towns from your "Territorial Aggression" Special Rule.)',
    threshhold: null,
    artist: 'Moro Rogers',
    status: 'active',
    from: null,
  ...
  'blood draws predators': {
    ...
    target: 'any land',
    effect:
      'After the next time Invaders are Destroyed in target land: Add 1 Beasts, then 1 Damage per Beasts (count max. 3 Beasts).',
    threshhold: null,
    artist: 'Kat Guevara',
    status: 'active',
    from: null,
  ...
  'volcanic eruption': {
    ...
    threshhold: {
      ...
      ability:
        'Destroy all Invaders. Add 1 Wilds. In each adjacent land: 10 Damage. Destroy all Dahan and Beasts. If there are no Blight, add 1 Blight.',
    },
    artist: 'Nolan Nasser',
    status: 'active',
    from: 'mountain',
  ...
  'vanish softly away, forgotten by all': {
    image:
      'https://spiritislandwiki.com/images/2/23/Vanish_Softly_Away%2C_Forgotten_by_All_%28je%29.png',
    set: ['Jagged Earth'],
    cardType: 'major',
    cost: 3,
    elements: ['m', 'a'],
  ...
  'lava flows': {
    ...
    range: 1,
    target: 'any land',
    effect: 'Add 1 Badlands and 1 Wilds. -or- 1 Damage.',
    threshhold: null,
    artist: 'Moro Rogers',
    status: 'active',
    from: null,
  ...
  'plows shatter on rocky ground': {
    ...
    range: 1,
    target: 'any land',
    effect: '1 Damage to each Town/City. Push up to 1 Town. -or- Destroy 1 Town.',
    threshhold: null,
    artist: 'Moro Rogers',
    status: 'active',
    from: null,
  ...
  'gift of furious might': {
    ...
    target: 'another spirit',
    effect:
      'Target Spirit may deal +3 Damage this turn with one of its Damage-dealing Powers. (This adds +3 Damage total, even for a Power that Damages multiple Invaders or each Invader.)',
    threshhold: null,
    artist: 'Moro Rogers',
    status: 'active',
    from: null,
  ...
  'bombard with boulders and stinging seeds': {
    image:
      'https://spiritislandwiki.com/images/3/3b/Bombard_with_Boulders_and_Stinging_Seeds_%28ni%29.png',
    set: ['Nature Incarnate'],
    cardType: 'major',
    cost: 2,
    elements: ['a', 'e', 'p'],
  ...
  'fields choked with growth': {
    ...
    range: 1,
    target: 'any land',
    effect: 'Push 1 Town. -or- Push 3 Dahan.',
    threshhold: null,
    artist: 'Jorge Ramos',
    status: 'active',
    from: null,
  ...
  'ravaged undergrowth slithers back to life': {
    image:
      'https://spiritislandwiki.com/images/7/78/Ravaged_Undergrowth_Slithers_Back_to_Life_%28ni%29.png',
    set: ['Nature Incarnate'],
    cardType: 'major',
    cost: 3,
    elements: ['w', 'p', 'n'],
    ...
    threshhold: {
      ...
      ability:
        'Add 1 Wilds. You may Push it. In each land with Wilds within 1 Range (of target land): Push 1 Explorer and 1 Town to lands without Wilds.',
    },
    artist: 'Kat Guevara',
    status: 'active',
    from: 'sacred site',
  ...
  'territorial strife': {
    ...
    range: 1,
    target: 'city',
    effect: '3 Damage to Explorers/Towns. -or- Add 1 Strife.',
    threshhold: null,
    artist: 'Kat Guevara',
    status: 'active',
    from: null,
  ...
  'inspire the release of stolen lands': {
    image:
      'https://spiritislandwiki.com/images/5/53/Inspire_the_Release_of_Stolen_Lands_%28ni%29.png',
    set: ['Nature Incarnate'],
    cardType: 'major',
    cost: 4,
    elements: ['s', 'w', 'p', 'n'],
    ...
    threshhold: {
      ...
      ability:
        'This Power can target lands with Blight. If Dahan are present, Remove 1 Blight from target land, then Remove 1 Explorer, 1 Town, and 1 City from a land within 1 Range (of target land).',
    },
  ...
  'flocking red-talons': {
    ...
    target: 'any land',
    effect:
      'Add 1 Beasts. Move up to 2 Beasts within 3 Range to target land. For each Beasts present, choose a different Invader. 1 Damage to each of those Invaders. Push 1 Explorer/Town per Beasts.',
    threshhold: {
      elements: {
        a: 2,
        p: 2,
  ...
  'exaltation of echoed steps': {
    ...
    target: 'another spirit',
    effect:
      'Target Spirit may Push 1 Presence, Bringing up to 1 Explorer/Town/Dahan. You may do likewise.',
    threshhold: null,
    artist: 'Emily Hancock',
    status: 'active',
    from: null,
  ...
  'unearth a beast of wrathful stone': {
    image:
      'https://spiritislandwiki.com/images/a/a6/Unearth_a_Beast_of_Wrathful_Stone_%28ni%29.png',
    set: ['Nature Incarnate'],
    cardType: 'major',
    cost: 5,
    elements: ['m', 'f', 'e', 'n'],
    ...
    target: 'invaders',
    effect:
      'After the next Invader Phase (on any turn) with no Ravage/Build Actions in target land: 3 Fear. 12 Damage. Add 1 Beasts. You may Push that Beasts. 1 Fear and 2 Damage in its land.',
    threshhold: {
      elements: {
        m: 2,
        e: 3,
      ...
      ability:
        "Mark it (Marked Beasts). Marked Beasts can't leave the island. Each Slow Phase: You may Push Marked Beasts. 1 Fear and 2 Damage at Marked Beasts.",
    },
    artist: 'David Markiwsky',
    status: 'active',
    from: 'sacred site',
  ...
  'jagged shards push from the earth': {
    image:
      'https://spiritislandwiki.com/images/7/7d/Jagged_Shards_Push_from_the_Earth_%28je%29.png',
    set: ['Jagged Earth'],
    cardType: 'unique',
    cost: 0,
    elements: ['f', 'e'],
  ...
  'emerge from the dread night wind': {
    ...
    target: 'any land',
    effect:
      'Add/Move your Incarna to target land. 1 Fear. If exactly 1 Invader is present, Abduct it. Otherwise, Push up to 2 Explorers/Towns to different lands.',
    threshhold: null,
    artist: 'David Markiwsky',
    status: 'active',
    from: null,
  ...
  'fragments of yesteryear': {
    ...
    threshhold: {
      ...
      ability:
        "This power may be Fast. 3 — 3 Moon: Don't Remove Dahan, any Spirit's Presence, or Spirit Tokens. Don't add Invaders/Blight.",
    },
    artist: 'David Markiwsky',
    status: 'active',
    from: null,
  ...
  'wrap in wings of sunlight': {
    ...
    target: 'any land',
    effect:
      'Move up to 5 Dahan to any land (including back into target land). If you moved at least 1 Dahan, Defend 5 in that land.',
    threshhold: {
      elements: {
        s: 2,
        a: 2,
  ...
  'plague ships sail to distant ports': {
    image:
      'https://spiritislandwiki.com/images/e/ea/Plague_Ships_Sail_to_Distant_Ports_%28ni%29.png',
    set: ['Nature Incarnate'],
    cardType: 'major',
    cost: 4,
    elements: ['f', 'a', 'w', 'n'],
    ...
    threshhold: {
      ...
      ability:
        'Instead: 1 Fear. 3 Damage. Spirits may jointly spend 3 Energy per player (aided by removing Disease from the island for 3 Energy each) to remove the top card of the Fear Deck from the game. Add 1 Disease.',
    },
    artist: 'Kat Guevara',
    status: 'active',
    from: null,
  ...
  'intractable thickets and thorns': {
    image:
      'https://spiritislandwiki.com/images/9/92/Intractable_Thickets_and_Thorns_%28hosi%29.png',
    set: ['Horizons of Spirit Island'],
    cardType: 'unique',
    cost: 2,
    elements: ['m', 'w', 'e', 'p'],
  ...
  'gift of the sunlit air': {
    ...
    target: 'any spirit',
    effect:
      'Target Spirit gets RangePlus1 with all their Powers. If you target another Spirit, they gain 1 Energy.',
    threshhold: null,
    artist: 'Lucas Durham',
    status: 'active',
    from: null,
  ...
  'mark territory with scars and teeth': {
    image:
      'https://spiritislandwiki.com/images/3/3c/Mark_Territory_with_Scars_and_Teeth_%28hosi%29.png',
    set: ['Horizons of Spirit Island'],
    cardType: 'unique',
    cost: 2,
    elements: ['s', 'e', 'n'],
  ...
  'bargain of coursing paths': {
    ...
    target: 'dahans',
    effect:
      'Bargain: 1 Presence now and -1 Energy/turn. Now: Mark both target land and another land with 2 or more Dahan. Ongoing: After pieces are added or moved into the marked lands: choose any land, then Move those pieces directly to that land.',
    threshhold: {
      elements: {
        a: 3,
        w: 2,
  ...
  'terror of the hunted': {
    ...
    target: 'any land',
    effect:
      "If Beasts are present, 1 Fear and Add 1 Strife. Add 1 Strife per Terror Level. If target land is the Endless Dark, Add 1 Strife. (Strife only escapes with the Invader it's attached to.)",
    threshhold: null,
    artist: 'David Markiwsky',
    status: 'active',
    from: null,
  ...
  'scatter to the winds': {
    ...
    target: 'any land',
    effect:
      'Choose up to 5 Explorers/Towns/Dahan. Push them to as many different lands as possible.',
    threshhold: null,
    artist: 'Lucas Durham',
    status: 'active',
    from: null,
  ...
  'reach from the infinite darkness': {
    ...
    target: 'yourself',
    effect:
      "Abduct up to 2 Presence (of any Spirits, with their permission) from any lands on the island, ignoring land type restrictions on moving Presence. Each Spirit's Presence in the Endless Dark grants them +1 Range with all their Powers (this turn).",
    threshhold: null,
    artist: 'David Markiwsky',
    status: 'active',
    from: null,
  ...
  'set them on an ever-twisting trail': {
    image:
      'https://spiritislandwiki.com/images/e/ea/Set_Them_on_an_Ever-Twisting_Trail_%28je%29.png',
    set: ['Jagged Earth'],
    cardType: 'minor',
    cost: 1,
    elements: ['a', 'p', 'n'],
  ...
  'solidify echoes of majesty past': {
    ...
    threshhold: {
      ...
      ability:
        'Target Spirit either Reclaims1 Power Card or re-gains 1 Unique Power they previously forgot. They may play it by paying its cost.',
    },
    artist: 'Emily Hancock',
    status: 'active',
    from: null,
  ...
  'favors of story and season': {
    ...
    target: 'another spirit',
    effect:
      'Target Spirit may Gather up to 3 Dahan into one of their lands. If they have at least 3 Dahan among their lands, they gain 1 Energy and may Reclaim 1 Power Card instead of discarding it at end of turn.',
    threshhold: null,
    artist: 'Aalaa Yassin',
    status: 'active',
    from: null,
  ...
  'wither bodies, scar stones': {
    ...
    range: 2,
    target: 'any land',
    effect: '1 Damage. -or- Add 1 Badlands.',
    threshhold: null,
    artist: 'Agnieszka Dabrowiecka',
    status: 'active',
    from: 'sacred site',
  ...
  'exaltation of the incandescent sky': {
    image:
      'https://spiritislandwiki.com/images/9/99/Exaltation_of_the_Incandescent_Sky_%28ni%29.png',
    set: ['Nature Incarnate'],
    cardType: 'major',
    cost: 7,
    elements: ['s', 'f', 'a', 'w'],
  ...
  'overgrow in a night': {
    ...
    range: 1,
    target: 'any land',
    effect: 'Add 1 Presence. -or- If target land has your Presence and Invaders, 3 Fear.',
    threshhold: null,
    artist: 'Jorge Ramos',
    status: 'active',
    from: null,
  ...
  'gift of seismic energy': {
    ...
    target: 'any spirit',
    effect:
      "If you target yourself, gain 3 energy. Otherwise, target spirit gains 1 Energy per Power Card you have in play (max.6). (Don't count Impendingcard.)",
    threshhold: null,
    artist: 'Emily Hancock',
    status: 'active',
    from: null,
  ...
  'stinging sandstorm': {
    ...
    target: 'any land',
    effect:
      'Gather up to 1 of your Presence. 1 Fear and 1 Damage. (If this Power makes a Sacred Site, your Special Rule applies immediately, giving Invaders there -1 Health and possibly Destroying Damaged Invaders.)',
    threshhold: null,
    artist: 'Lucas Durham',
    status: 'active',
    from: null,
  ...
  'exhale confusion and delirium': {
    ...
    target: 'strife',
    effect:
      "2 Fear. Invaders with Strife don't participate in Ravage. (Check when Ravaging; they don't do Damage or take counterattack Damage.)",
    threshhold: null,
    artist: 'Emily Hancock',
    status: 'active',
    from: null,
  ...
  'whispered guidance through the night': {
    image:
      'https://spiritislandwiki.com/images/3/34/Whispered_Guidance_Through_the_Night_%28hosi%29.png',
    set: ['Horizons of Spirit Island'],
    cardType: 'unique',
    cost: 0,
    elements: ['m', 'a', 'p'],
  ...
  'unbearable gaze': {
    ...
    target: 'any land',
    effect:
      '1 Fear. Push 2 Explorers/Towns from origin or target land (or 1 Explorer/Town from each).',
    threshhold: null,
    artist: 'Agnieszka Dabrowiecka',
    status: 'active',
    from: 'sacred site',
  ...
  'blooming of the rocks and trees': {
    ...
    target: 'any land',
    effect:
      'If no Blight is Present, Add 1 Vitality. -or- If no Invaders are Present, Add 1 Strife.',
    threshhold: {
      elements: {
        p: 3,
      },
  ...
  'surrounded by the dahan': {
    ...
    target: 'dahan',
    effect:
      '2 Fear if Invaders are present. 1 Fear if Dahan outnumber Towns/Cities. Isolate target land.',
    threshhold: null,
    artist: 'Aalaa Yassin',
    status: 'active',
    from: null,
  ...
  'bloodwrack plague': {
    ...
    threshhold: {
      ...
      ability:
        '2 Fear. For each Disease in target land, do 1 Damage in target or an adjacent land.',
    },
    artist: 'Jorge Ramos',
    status: 'active',
    from: 'sacred site',
  ...
  'frightful keening': {
    ...
    effect:
      'Push your Incarna. If this pushes your Incarna into a land with Invaders, 2 Fear there (before adding Strife).',
    threshhold: null,
    artist: 'Emily Hancock',
    status: 'active',
    from: null,
  ...
  'transform to a murderous darkness': {
    image:
      'https://spiritislandwiki.com/images/6/66/Transform_to_a_Murderous_Darkness_%28je%29.png',
    set: ['Jagged Earth'],
    cardType: 'major',
    cost: 6,
    elements: ['m', 'f', 'a', 'w', 'p'],
    ...
    target: 'any spirit',
    effect:
      'Target Spirit may choose one of their Sacred Site. In that land: Replace all their Presence with Badlands; the replaced Presence leaves the game. Push any number of those Badlands. 3 Fear. 3 Damage per Presence Replaced.',
    threshhold: {
      elements: {
        m: 3,
        f: 2,
  ...
  'rumbling earthquakes': {
    ...
    target: 'any land',
    effect:
      'This Power ignores Health bonuses. 3 Fear. 6 Damage, to Towns/Cities only. 6 Damage among adjacent lands, to Towns/Cities only.',
    threshhold: {
      elements: {
        e: 4,
      },
  ...
  'rumblings portend a greater quake': {
    image:
      'https://spiritislandwiki.com/images/1/1e/Rumblings_Portend_a_Greater_Quake_%28ni%29.png',
    set: ['Nature Incarnate'],
    cardType: 'unique',
    cost: 1,
    elements: ['s', 'm', 'a', 'e'],
    ...
    target: 'any land',
    effect:
      'If you have at least as many Impending Cards as Power Cards in play, 1 Fear and Add 1 Quake. Push up to 3 Dahan.',
    threshhold: null,
    artist: 'Emily Hancock',
    status: 'active',
    from: null,
  ...
  'terrifying rampage': {
    ...
    target: 'any land',
    effect:
      "1 Fear. 2 Invaders don't participate in Ravage. (Choose when ravaging; they don't do Damage or take counterattack Damage.) Push 3 Dahan.",
    threshhold: null,
    artist: 'David Markiwsky',
    status: 'active',
    from: null,
  ...
  'blinding glare': {
    ...
    range: 0,
    target: null,
    effect: '2 Fear. -or- Skip up to one Ravage Action.',
    threshhold: {
      elements: {
        s: 5,
      },
  ...
  'twist perceptions': {
    ...
    target: 'invaders',
    effect:
      'Add 1 Strife. You may Push the Invader you added Strife to. (If you add Strife to Explorers/Towns, you can push that Invader first with Senseless Roaming before pushing it with this Power.)',
    threshhold: null,
    artist: 'Emily Hancock',
    status: 'active',
    from: null,
  ...
  'boon of corrupted blood': {
    ...
    target: 'any spirit',
    effect:
      "1 Damage in one of target Spirit's lands. If you target another Spirit, in that land also: Destory 1 of their Presence. 1 Damage. Gather 1 Beasts.",
    threshhold: null,
    artist: 'Nolan Nasser',
    status: 'active',
    from: null,
  ...
  'growth through sacrifice': {
    ...
    target: 'any spirit',
    effect:
      'Destroy 1 of your Presence. Target Spirit chooses to either: Remove 1 Blight from one of their lands. -or- Add 1 Presence to one of their lands.',
    threshhold: {
      elements: {
        s: 2,
      },
  ...
  'transformative sacrifice': {
    ...
    target: 'any spirit',
    effect:
      'Target Spirit may Remove up to 3 Presence (from anywhere on the island). Then for each removed Presence, they Take a Minor Power and play it (for free).',
    threshhold: {
      elements: {
        m: 2,
        f: 3,
      ...
      ability:
        'Before taking cards, they may also Remove 1 Presence from their Presence track to Take a Minor Power and play it.',
    },
    artist: 'Kat Guevara',
    status: 'active',
    from: null,
  ...
  'belligerent and aggressive crops': {
    ...
    target: 'town or city',
    effect:
      'Add 1 Wilds. 1 Damage, to Towns/Cities only. If there are any adjacent Wilds: 1 Fear. 1 Damage, to Towns/Cities only.',
    threshhold: null,
    artist: 'David Markiwsky',
    status: 'active',
    from: 'sacred site',
  ...
  'draw towards a consuming void': {
    ...
    set: ['Jagged Earth', 'Nature Incarnate'],
    cardType: 'major',
    cost: 8,
    elements: [],
    speed: 'slow',
    ...
    threshhold: {
      ...
      ability:
        'Any number of times: Forget a Minor Power, a Major Power, and a Unique Power to perform the above effects again.',
    },
    artist: 'Joshua Wright',
    status: 'active',
    from: null,
